        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-16">
          <div className="col-span-2 md:col-span-1">
            <a href="/" className="inline-block mb-4">
              <span className="text-2xl font-bold text-excali-blue">Excalidraw</span>
            </a>
            <p className="text-muted-foreground mb-4 max-w-xs">
              The collaborative drawing tool that makes creating diagrams with your team a breeze.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-foreground">Libraries</a></li>
